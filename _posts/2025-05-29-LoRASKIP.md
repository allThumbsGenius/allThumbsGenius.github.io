...
tags: [Efficient AI]
image:
  path: /images/LoRASKIP_conceptmap.png
  feature: LoRASKIP_conceptmap.png

image_path: {{ site.url }}/images/loraskip
---
...
<!-- ![Fig 1. Neuron pruning on children’s brain]({{ site.url }}/images/pruning_motivation.png) -->
![Fig 1. Neuron pruning on children’s brain](pruning_motivation.png)

Fig 1. Neuron pruning on children’s brain
